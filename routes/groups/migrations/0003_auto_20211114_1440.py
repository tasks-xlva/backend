# Generated by Django 3.2.9 on 2021-11-14 14:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='role',
            field=models.CharField(choices=[('ADMIN', 'Администратор'), ('EDITOR', 'Редактор'), ('MEMBER', 'Участник')], max_length=15, null=True),
        ),
        migrations.AlterField(
            model_name='membership',
            name='user',
